...
// To use this app:
// 1. Create a project that you want to track. Include a purpose to help you remember why this is worth tracking!
// 2. Add a set of defaults to the project that you want to track for each date.
// 3. Enter data for a date that you did something with the project.
// 4. Export the data as XLS or JSON!
